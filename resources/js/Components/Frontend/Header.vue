    ...
    <nav class="w-full fixed z-20  border-gray-200 px-2 sm:px-4 py-2.5 rounded " :class="{
        ...
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            <a href="#" class="flex items-center">
                <img src="/img/Logo.png" class="mr-3 h-6 sm:h-9" alt="VAWM Logo">
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">VAWM</span>
            </a>
            ...
            <div class="w-full md:block md:w-auto" :class="{ hidden: showMobileMenu }" id="navbar-default">
                <ul
                    class="flex flex-col p-4 mt-4 bg-light-secondary rounded-lg border border-light-tail-500 dark:border-dark-navy-100 md:flex-row md:space-x-8 md:mt-0 md:font-medium md:border-0 dark:bg-dark-secondary">
