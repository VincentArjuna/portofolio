    ...
    <section id="contact" class="section bg-light-primary dark:bg-dark-primary">
        <div class="container mx-auto" v-motion :initial="{ opacity: 0, y: 100, }" :visible="{ opacity: 1, y: 0, }">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="subtitle">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam ultricies arcu quis nisi scelerisque
                    congue. Curabitur rhoncus mauris sit amet dui condimentum pretium.
                </p>
            </div>
                ...
                <div class="flex flex-1 flex-col items-start space-y-8 mb-12 lg:mb-0 lg:pt-2">
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-accent font-normal">Email me at vincentiusmandala@gmail.com</p>
                        </div>
                    </div>
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        <div
                        ...
                        <div>
                            ...
                            <p class="mb-1 text-paragraph">Surabaya, Indonesia.</p>
